            ...
            <template #cell(actions)="row">
              <b-button-group>
                <b-button
                  ...
                  size="sm"
                  :to="{ path: '/doctor/update/' + row.item.id }"
...
export default {
  ...
  methods: {
    ...
    UpdateDoctor(item) {
      let self = this;
      self.$router.push({ path: "/doctor/update/" + item.id });
    }
  }
};
</script>
